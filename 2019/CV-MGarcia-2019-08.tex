...
\makecvtitle
	...
	\section{\texorpdfstring{\faBuilding\ Experience}{Experience}}
		\mycvitemXP{2016-2019}{Bioinformatician}{Barntumörbanken | Karolinska Institutet}{Stockholm, Sweden}
		\mycomment{Development of a Whole Genome/Targeted Sequencing Germline/Somatic analysis workflow in collaboration with SciLifeLab NGI \& NBIS;}
		\mycomment{\faGithub\ \myurl{https://github.com/nf-core/sarek}}
		\mycomment{Development of a RNA-fusion analysis workflow in collaboration with SciLifeLab NGI;}
		\mycomment{\faGithub\ \myurl{https://github.com/nf-core/rnafusion}}
		\mycomment{In the Core team that administer the nf-core project;}
		\mycomment{\faGlobeEurope\ \myurl{https://nf-co.re/}}
