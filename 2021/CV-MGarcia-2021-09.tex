...
\makecvtitle
	...
	\section{\texorpdfstring{\faBuilding\ Experience}{Experience}}
		\mycvitemXP{From 2016}{Bioinformatician}{Barntumörbanken | Karolinska Institutet}{Stockholm, Sweden}
		\mycomment{\faGithub\ \myuline{\href{https://github.com/nf-core/sarek}{\nolinkurl{nf-core/sarek}}} - Development of a Whole Genome/Targeted Sequencing Germline/Somatic analysis workflow in collaboration with SciLifeLab NGI \& NBIS;}
		\mycomment{\faGithub\ \myuline{\href{https://github.com/nf-core/rnafusion}{\nolinkurl{nf-core/rnafusion}}} - Development of a RNA-fusion analysis workflow in collaboration with SciLifeLab NGI;}
		\mycomment{\faGithub\ \myuline{\href{https://github.com/nf-core/rnavar}{\nolinkurl{nf-core/rnavar}}} - Development of a RNA-seq analysis workflow;}
