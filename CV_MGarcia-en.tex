...
\firstname{Maxime}
\familyname{Garcia}
\title{Research Associate in Bioinformatics}
\extrainfo{Date of birth: 05/14/1982\\Nationality: French}
%\address{4, Rue St Jacques}{13006 Marseille France}
\address{Block 135, Jalan Bukit Merah}{\#12-1442, Singapore 160135}
\mobile{+65-8443-6559}							% optional, remove the line if not wanted
%\mobile{+33(0)6-18-04-65-08}                	% optional, remove the line if not wanted
\email{max@ithake.eu}						   	% optional, remove the line if not wanted
\homepage{http://ithake.eu/}                	% optional, remove the line if not wanted
%\photo[64pt][0.4pt]{picture}               	% '64pt' is the height the picture must be resized to, 0.4pt is the thickness of the frame around it (put it to 0pt for no frame) and 'picture' is the name of the picture file; optional, remove the line if not wanted
\quote{Bioinformatics researcher specialized in\\large scale data integration and visualization} % optional, remove the line if not wanted

\begin{document}
\makecvtitle
\section{Experiences}

\cventry{2013--2013}{Research Associate in \textit{Bioinformatics}}{}{National University of Singapore - Cancer Science Institute of Singapore}{Singapore}{}
...
\cvitem{article}{T. Bonacci et al., Chemotherapy induced changes of post-translational modifications by ubiquitin and ubiquitin-like proteins in pancreatic cancer cells, Molecular \& Cellular Proteomics, \textit{submited}}
\cvitem{chapter}{M. Garcia et al., Detection of driver protein complexes in breast cancer metastasis by large scale transcriptome-interactome integration \textit{submitted}}
\cvitem{article}{M. Garcia et al., Interactome-Transcriptome integration for predicting distant metastasis in breast cancer, Bioinformatics, 2012}
...
\cvitem{English}{Fluent, 2 months humanitarian aid in Sri Lanka, TOEIC: 945}
...
\cvitem{Associations}{Vice-president of JeBiF - RSG-France (Association of French Young Bioinformaticians)}
