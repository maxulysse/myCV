...
\RequirePackage[scale=0.92]{geometry}

\setlength{\hintscolumnwidth}{3cm}
\name{Maxime Ulysse}{Garcia}
\title{PhD in Bioinformatics}
\extrainfo{Date of birth: 1982-05-14\\Nationality: French}
...
\begin{document}
	\makecvtitle
	\section{Experiences}
		\cventry{2016 -- ongoing}{Bioinformatician}{}{BarnTumörBanken - Sitting at both Karolinska Institutet / Instutitionen För Onkologi-Patologi and at Science for Life Laboratory / NGI Stockholm (Genomics Applications)}{Stockholm}{}
